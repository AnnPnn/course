...
class MainActivity : AppCompatActivity() {
     ...
     *
     * (НЕ ИЗМЕНЯЙТЕ ИМЕНА ПЕРЕМЕННЫХ ИЛИ ЗНАЧЕНИЙ ИЛИ ИХ НАЧАЛЬНЫЕ ЗНАЧЕНИЯ.
     *
     * Ожидается, что все, что помечено как var вместо val, будет изменено в функциях, но НЕ
     * измените их начальные значения, объявленные здесь, это может привести к неправильной работе приложения.)
     */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // === DO NOT ALTER THE CODE IN THE FOLLOWING IF STATEMENT Не изменяем ===
    ...
    /**
     * === DO NOT ALTER THIS METHOD не изменяем===
     *
     ...
     * Нажатие вызовет разный ответ в зависимости от состояния.
     * Этот метод определяет состояние и выполняет правильные действия.
     */
